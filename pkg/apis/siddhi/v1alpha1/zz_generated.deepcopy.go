...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SiddhiIngress) DeepCopyInto(out *SiddhiIngress) {
	*out = *in
	out.TLSSpec = in.TLSSpec
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SiddhiIngress.
func (in *SiddhiIngress) DeepCopy() *SiddhiIngress {
	if in == nil {
		return nil
	}
	out := new(SiddhiIngress)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SiddhiProcessSpec) DeepCopyInto(out *SiddhiProcessSpec) {
	*out = *in
	...
	out.SiddhiIngress = in.SiddhiIngress
	return
}
