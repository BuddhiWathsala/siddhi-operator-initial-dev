...
func (r *ReconcileSiddhiProcess) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling SiddhiProcess")

	// Fetch the SiddhiProcess instance
	instance := &siddhiv1alpha1.SiddhiProcess{}
...
func newPodForCR(cr *siddhiv1alpha1.SiddhiProcess) *corev1.Pod {
